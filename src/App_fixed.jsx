...
const globalCss = `
  ...
  *::-webkit-scrollbar-thumb:hover {
  ...
  /* ================= MOBILE AUTH LANDING ================= */
  @media (max-width: 700px) {
    .authTopbar { padding: 10px 14px !important; height: 48px !important; }
    .authSecure { font-size: 8px !important; letter-spacing: .25px !important; opacity: .72; }
    .authTopbar > div:first-child { max-width: 150px !important; overflow: hidden !important; white-space: nowrap !important; text-overflow: ellipsis !important; }

    .authWrap { justify-content: flex-start !important; padding: 68px 20px 22px !important; gap: 12px !important; overflow-x: hidden !important; overflow-y: auto !important; }
    .authBrand { margin: 0 auto 8px !important; gap: 9px !important; }
    .authLogo { width: 38px !important; height: 38px !important; border-radius: 11px !important; }
    .authBrandSub { font-size: 7px !important; letter-spacing: 1.2px !important; }

    .authLanding { display: flex !important; flex-direction: column !important; width: 100% !important; max-width: 440px !important; gap: 0 !important; text-align: center !important; align-items: center !important; }
    .authLandingCopy { width: 100% !important; max-width: 440px !important; display: flex !important; flex-direction: column !important; align-items: center !important; }
    .authLandingBadge { padding: 6px 10px !important; font-size: 8.5px !important; letter-spacing: .8px !important; }
    .authLandingCopy > div:nth-child(2) { margin-top: 13px !important; gap: 7px !important; }
    .authLandingCopy > div:nth-child(2) svg { width: 28px !important; height: 28px !important; }
    .authLandingCopy > div:nth-child(2) span { font-size: 16px !important; }
    .authLandingTitle { width: 100% !important; margin: 13px 0 11px !important; font-size: clamp(31px, 10.5vw, 43px) !important; line-height: 1.02 !important; letter-spacing: -2px !important; }
    .authLandingText { width: 100% !important; max-width: 370px !important; font-size: 12px !important; line-height: 1.58 !important; color: #8b949e !important; }

    .authLandingActions { display: grid !important; grid-template-columns: 1fr 1fr !important; width: 100% !important; max-width: 390px !important; gap: 9px !important; margin-top: 21px !important; }
    .authLandingPrimary, .authLandingSecondary { min-height: 49px !important; width: 100% !important; padding: 0 11px !important; border-radius: 12px !important; font-size: 12px !important; }
    .authLandingPrimary svg, .authLandingSecondary svg { width: 16px !important; height: 16px !important; }
    .authLandingTrust { width: 100% !important; justify-content: center !important; gap: 8px 12px !important; margin-top: 16px !important; font-size: 9px !important; }

    /* Telefonda masaüstü 3 sütunlu sahte uygulama önizlemesini kaldır. */
    .authPreviewWrap { display: none !important; }
    .authGlow { width: 320px !important; height: 320px !important; top: 42% !important; opacity: .65 !important; }
    .authHeroImg { opacity: .20 !important; transform: scale(1.08) !important; }
    .authHeroOverlay { background: linear-gradient(180deg, #07090ef2 0%, #07090ee8 42%, #07090ef8 100%) !important; }
    .authNote { max-width: 360px !important; margin-top: 12px !important; font-size: 8.5px !important; line-height: 1.4 !important; text-align: center !important; }
  }

  @media (max-width: 380px) {
    .authWrap { padding-left: 14px !important; padding-right: 14px !important; }
    .authLandingTitle { font-size: 30px !important; letter-spacing: -1.6px !important; }
    .authLandingText { font-size: 11.5px !important; }
    .authLandingActions { gap: 7px !important; }
    .authLandingPrimary, .authLandingSecondary { min-height: 47px !important; font-size: 11px !important; }
    .authLandingTrust { font-size: 8.5px !important; }
  }
`;
