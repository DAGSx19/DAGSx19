...
// ---------- DAGSx19 LANDING PAGE EKLENTİSİ ----------
      ...
      <div style={{ ...styles.app, background: T.bg, color: T.text }}>
        ...
        <div style={styles.authWrap}>
          <div style={styles.authBrand}>
            <div style={styles.authLogo}><Radio size={23} color="#39FF88" style={{ animation: "pulse 2s infinite" }} /></div>
          ...
          {authView === "landing" && (
            <div style={styles.authLanding}>
              ...
              <h1 style={{ ...styles.authLandingTitle, color: T.textStrong }}>Sohbete katıl.<br /><span style={{ color: "#39FF88" }}>Bağlantıda kal.</span></h1>
              <p style={{ ...styles.authLandingText, color: T.textDim }}>DAGSx19 ile arkadaşlarınla konuş, topluluklara katıl ve kendi alanını oluştur.</p>
              ...
              <div style={styles.authLandingFeatures}>
                <div style={{ ...styles.authFeature, borderColor: T.border, background: T.panel }}>
                  <MessageSquare size={16} color="#39FF88" />
                  <div><strong style={{ display: "block", color: T.textStrong, marginBottom: 3 }}>Gerçek zamanlı sohbet</strong><span style={{ display: "block", color: T.textDim }}>Topluluğunla anında iletişim.</span></div>
                </div>
                <div style={{ ...styles.authFeature, borderColor: T.border, background: T.panel }}>
                  <ShieldCheck size={16} color="#39FF88" />
                  <div><strong style={{ display: "block", color: T.textStrong, marginBottom: 3 }}>Güvenli alan</strong><span style={{ display: "block", color: T.textDim }}>Hesabın ve topluluğun senin.</span></div>
                </div>
              </div>
